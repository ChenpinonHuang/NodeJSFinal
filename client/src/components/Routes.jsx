    ...
    <Switch>
      ...
      
      {
        /*
          ...
          ANSWER HERE: The route will extract the later part of path of the require and according to the path name to direct to different page. 
          The code will also send the user and other parameter when it was called.
        */
      }
